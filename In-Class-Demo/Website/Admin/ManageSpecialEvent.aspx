<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ManageSpecialEvent.aspx.cs" Inherits="Admin_ManageSpecialEvent" %>
    ...
    <div class="row col-md-12">
        ...
        <asp:ObjectDataSource ID="SpecialEventsDataSource" runat="server"
            ...
            DataObjectTypeName="eRestaurant.Framework.Entities.SpecialEvent" OldValuesParameterFormatString="original_{0}"
             UpdateMethod="UpdateSpecialEvent" DeleteMethod="DeleteSpecialEvent" InsertMethod="AddSpecialEvent">
        ...
        <asp:ListView ID="SpecialEventsListView" runat="server" 
             DataSourceID="SpecialEventsDataSource" DataKeyNames="EventCode"
             InsertItemPosition ="LastItem">
            <LayoutTemplate>
                <fieldset runat="server" id="itemPlaceHolderContaianer">
            ...
            <ItemTemplate>
                <div>
                    <!--<asp:LinkButton runat="server" CommandName="Insert" ID="InsertButton">Insert
                        <span class="glphicon glyphicon-plus"></span></asp:LinkButton>
                    &nbsp;&nbsp;&nbsp;-->
            ...
            <InsertItemTemplate>
                <div>
                    ...
                    <asp:Label ID="Label4" runat="server" CssClass="control-label"
                        AssociatedLabelControlID="DescriptionTextBox">Description</asp:Label>
